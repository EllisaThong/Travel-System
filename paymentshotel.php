...
$bookingQuery = $conn->prepare("SELECT b.*, h.hotelName FROM bookings b JOIN hotels h ON b.hotelID = h.hotelID WHERE b.bookingID = ? AND b.userID = ?");
...
<div class="payment-container" style="margin: 50px auto; max-width: 600px; background: #e9ecef; padding: 30px; border-radius: 12px;">
    ...
    <div class="summary-item"><strong>Hotel:</strong> <?= htmlspecialchars($booking['hotelName']) ?></div>
