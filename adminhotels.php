...
<head>
    ...
    <link rel="stylesheet" href="adminhotels.css">
</head>
<body>
    ...
    <div class="hotel-container">
        ...
        <!-- Add Hotel Button -->
        <div class="top-bar">
            <a href="addhotels.php" class="add-button">Add Hotel</a>
        </div>
        ...
        <div class="hotel-list">
            ...
            if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<a href='edithotels.php?id=" . $row["hotelID"] . "' class='admin-btn edit-btn'>Edit</a>";
                    echo "<a href='deletehotels.php?id=" . $row["hotelID"] . "' class='admin-btn delete-btn' onclick=\"return confirm('Are you sure you want to delete this hotel?');\">Delete</a>";
                    echo "</div>";
