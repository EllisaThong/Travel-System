...
$bookingQuery = $conn->prepare("SELECT b.*, p.packageName FROM bookings b JOIN packages p ON b.packageID = p.packageID WHERE b.bookingID = ? AND b.userID = ?");
...
<div class="payment-container" style="margin: 50px auto; max-width: 600px; background: #e9ecef; padding: 30px; border-radius: 12px;">
    ...
    <div class="summary-item"><strong>Package:</strong> <?= htmlspecialchars($booking['packageName']) ?></div>
